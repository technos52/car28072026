...
final class $$UsersTableReferences
  ...
  static MultiTypedResultKey<$ShopsTable, List<Shop>> _shopsRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.shops,
    aliasName: $_aliasNameGenerator(db.users.id, db.shops.userId),
  );

  $$ShopsTableProcessedTableManager get shopsRefs {
    final manager = $$ShopsTableTableManager(
      $_db,
      $_db.shops,
    ).filter((f) => f.userId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_shopsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }

  static MultiTypedResultKey<$KycDocumentsTable, List<KycDocument>>
  _kycDocumentsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.kycDocuments,
    aliasName: $_aliasNameGenerator(db.users.id, db.kycDocuments.userId),
  );

  $$KycDocumentsTableProcessedTableManager get kycDocumentsRefs {
    final manager = $$KycDocumentsTableTableManager(
      $_db,
      $_db.kycDocuments,
    ).filter((f) => f.userId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(_kycDocumentsRefsTable($_db));
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
  }
  ...
  static MultiTypedResultKey<$CarsTable, List<Car>> _carsRefsTable(
    ...
    db.cars,
    aliasName: $_aliasNameGenerator(db.users.id, db.cars.userId),
  );
...
class $$UsersTableFilterComposer extends Composer<_$AppDatabase, $UsersTable> {
  ...
  Expression<bool> shopsRefs(
    Expression<bool> Function($$ShopsTableFilterComposer f) f,
  ) {
  ...
  Expression<bool> kycDocumentsRefs(
    Expression<bool> Function($$KycDocumentsTableFilterComposer f) f,
  ) {
    final $$KycDocumentsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.kycDocuments,
      getReferencedColumn: (t) => t.userId,
      builder:
          (
            joinBuilder, {
...
class $$UsersTableAnnotationComposer
  ...
  Expression<T> shopsRefs<T extends Object>(
    Expression<T> Function($$ShopsTableAnnotationComposer a) f,
  ) {
  ...
  Expression<T> kycDocumentsRefs<T extends Object>(
    Expression<T> Function($$KycDocumentsTableAnnotationComposer a) f,
  ) {
    final $$KycDocumentsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.kycDocuments,
      getReferencedColumn: (t) => t.userId,
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                shopsRefs = false,
                kycDocumentsRefs = false,
                carsRefs = false,
              }) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (shopsRefs) db.shops,
                    if (kycDocumentsRefs) db.kycDocuments,
                    if (carsRefs) db.cars,
                  ],
                  addJoins: null,
                  getPrefetchedDataCallback: (items) async {
                    return [
                      if (shopsRefs)
                        await $_getPrefetchedData<User, $UsersTable, Shop>(
                          currentTable: table,
                          referencedTable: $$UsersTableReferences
                              ._shopsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$UsersTableReferences(db, table, p0).shopsRefs,
                      ...
                      if (carsRefs)
                        await $_getPrefetchedData<User, $UsersTable, Car>(
                          currentTable: table,
                          referencedTable: $$UsersTableReferences
                              ._carsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$UsersTableReferences(db, table, p0).carsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.userId == item.id,
                              ),
...
final class $$ShopsTableReferences
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) =>
      db.users.createAlias($_aliasNameGenerator(db.shops.userId, db.users.id));
...
final class $$KycDocumentsTableReferences
    extends BaseReferences<_$AppDatabase, $KycDocumentsTable, KycDocument> {
  $$KycDocumentsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $UsersTable _userIdTable(_$AppDatabase db) => db.users.createAlias(
    $_aliasNameGenerator(db.kycDocuments.userId, db.users.id),
  );
...
class $$KycDocumentsTableTableManager
    extends
        RootTableManager<
          ...
          (KycDocument, $$KycDocumentsTableReferences),
          KycDocument,
          PrefetchHooks Function({bool userId})
        > {
        ...
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$KycDocumentsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({userId = false}) {
                    ...
                    if (userId) {
                      state =
                          state.withJoin(
                                currentTable: table,
                                currentColumn: table.userId,
                                referencedTable: $$KycDocumentsTableReferences
                                    ._userIdTable(db),
                                referencedColumn: $$KycDocumentsTableReferences
                                    ._userIdTable(db)
                                    .id,
                              )
                              as T;
...
final class $$CarsTableReferences
  ...
  static $UsersTable _userIdTable(_$AppDatabase db) =>
      db.users.createAlias($_aliasNameGenerator(db.cars.userId, db.users.id));
                      ...
                      state =
                          state.withJoin(
                                ...
                                referencedTable: $$CarsTableReferences
                                    ._userIdTable(db),
                                referencedColumn: $$CarsTableReferences
                                    ._userIdTable(db)
                                    .id,
                              )
                              as T;
